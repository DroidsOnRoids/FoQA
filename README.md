...
```groovy
dependencies {
    debugImplementation 'pl.droidsonroids.foqa:deviceinfo:0.0.12'
}
```
...
```groovy
dependencies {
    debugImplementation 'pl.droidsonroids.foqa:fontscale:0.0.12'
}
```
### Chuck plugin
...
```groovy
dependencies {
    debugImplementation 'pl.droidsonroids.foqa:chuck:0.0.12'
}
```
